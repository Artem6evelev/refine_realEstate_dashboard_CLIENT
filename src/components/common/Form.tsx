import {
  ...
  MenuItem,
  Button,
  textTransform} from '@pankod/refine-mui'
      ...
      <Box mt={2.5} borderRadius='15px' padding='20px' bgcolor='#fcfcfc'>
        ...
        <Stack direction='row' gap={4}>
          <FormControl sx={{flex:1}}>
            <FormHelperText sx={{fontWeight:500, margin:'10px 0', fontSize: 16, color:'#11142b'}}>
          ...
          <FormControl>
          <FormHelperText sx={{fontWeight:500, margin:'10px 0', fontSize: 16, color:'#11142d'}}>Location</FormHelperText>
          <TextField
          fullWidth
          required
          id='outlined-basic'
        ...
        <Stack direction='column' gap={1} justifyContent='center' mb={2}>
          <Stack direction='row' gap={2}>
            ...
            <Button component='label' sx={{wisth:'fit-content', color:'#2ed480', textTransform:'capitalize', fonstSize: 16}}>
              Upload *
              <input
              hidden
              accept='image/*'
